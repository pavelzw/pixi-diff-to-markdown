...
|llvm-openmp|17.0.6|18.1.7|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020, py310, py311, py312, py39} on osx-arm64<br/>*all envs* on osx-64|
|packaging|23.2|24.1|false|*all*|
|setuptools|68.2.2|70.0.0|false|default on osx-arm64|
|setuptools|69.0.3|70.0.0|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020, py310, py311, py312, py39} on osx-arm64<br/>*all envs* on {linux-64, osx-64, win-64}|
|tzdata|2023c|2024a|false|default on osx-arm64|
|tzdata|2023d|2024a|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020, py310, py311, py312, py39} on osx-arm64<br/>*all envs* on {linux-64, osx-64, win-64}|
...
|openssl|3.2.1|3.3.1|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020} on osx-arm64<br/>*all envs* on {linux-64, osx-64, win-64}|
...
|typing_extensions|4.9.0|4.12.2|false|pl019 on {linux-64, osx-64, osx-arm64}<br/>{pl016, pl017, pl018, pl020, py310, py39} on *all platforms*|
...
|wheel|0.42.0|0.43.0|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020, py310, py311, py312, py39} on osx-arm64<br/>*all envs* on {linux-64, osx-64, win-64}|
...
|libopenblas|0.3.26|0.3.27|false|{lint, pl014, pl015, pl016, pl017, pl018, pl019, pl020, py310, py311, py312, py39} on osx-arm64<br/>*all envs* on {linux-64, osx-64}|
|libxml2|2.12.4|2.12.7|false|*all envs* on win-64|
|numpy|1.26.2|1.26.4|false|default on osx-arm64|
|numpy|1.26.3|1.26.4|false|default on {linux-64, osx-64, win-64}<br/>{lint, py310, py311, py312, py39} on *all platforms*|
